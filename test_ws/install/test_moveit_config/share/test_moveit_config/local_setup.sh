...
: ${AMENT_CURRENT_PREFIX:="/home/fzf/Downloads/robot_arm/test_ws/install/test_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_moveit_config/environment/path.sh"
