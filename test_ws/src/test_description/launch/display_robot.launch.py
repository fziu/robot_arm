...
def generate_launch_description():
    ...
    robot_description_content = Command([
        ...
        PathJoinSubstitution([FindPackageShare("test_description"), "urdf", "test.urdf.xacro"])]
    )
    ...
    delay_trajectory_controller_after_joint_state_broadcaster = RegisterEventHandler(
        event_handler=OnProcessExit(
    ...
    delay_rviz_after_trajectory_controller = RegisterEventHandler(
        event_handler=OnProcessExit(
    ...
    return LaunchDescription([
        ...
        delay_trajectory_controller_after_joint_state_broadcaster,
        delay_rviz_after_trajectory_controller
    ])